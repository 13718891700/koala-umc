        ...
        <div class="form-group">
          ...
          <div class="input-icon">
            <input class="form-control-code placeholder-no-fix" type="text" autocomplete="off"
                   placeholder="验证码" id="kaptcha" name="kaptcha"/>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
					<span class="input-group-btn-1">
						<img src="/umc/captcha/genetrateKaptchaImage" onclick="changeVerifyCode()" id="yzmImg" style="cursor: pointer;">
...
<script>
  ...
  function changeVerifyCode() {
    $("#yzmImg").attr("src", "/umc/captcha/genetrateKaptchaImage?" + Math.floor(Math.random() * 100));
  }
