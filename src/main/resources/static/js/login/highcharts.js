...
(function (D, aa) {
    ...
    function Ka(a, b) {
        ...
        (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                h = U.lang,
                i = void 0,
                /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = x.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Qa(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    Wa = function (a, b, c) {
            ...
            c.curAnim = E(b);
            for (h in b) g = new pb(a, c, h),
            f = null,
            h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(na(a, h)) || 0, h !== "opacity" && (e = "px")),
            f || (f = b[h]),
    ...
    ma.prototype = {
            ...
            brighten: function (a) {
                ...
                else if (J(a) && a !== 0) for (b = 0; b < 3; b++) c[b] += C(a * 255),
                c[b] < 0 && (c[b] = 0),
                c[b] > 255 && (c[b] = 255);
                return this
            },
    ...
    O.prototype = {
                ...
                if (!c) {
                        if (h.namespaceURI === Ha || d.forExport) {
                            try {
                                ...
                                Na && j.textShadow ? (k = j.textShadow, j.textShadow = "") : l && l("none"),
                                c = h.getBBox ? u({}, h.getBBox()) : {
                                    width: h.offsetWidth,
                        ...
                        if (d.isSVG) {
                            ...
                            if (f) c.width = Q(e * da(g)) + Q(d * W(g)),
                            c.height = Q(e * W(g)) + Q(d * da(g))
                        }
                        if (q) {
            ...
            shadow: function (a, b, c) {
                ...
                if (a) {
                        ...
                        for (e = 1; e <= i; e++) {
                            ...
                            if (c) P(f, "height", t(P(f, "height") - h, 0)),
                            f.cutHeight = h;
            ...
            zIndexSetter: function (a, b) {
                ...
                if (e) {
                        ...
                        d = c.childNodes;
                        for (i = 0; i < d.length && !h; i++) if (e = d[i], f = e.zIndex, e !== g && (C(f) > a || !r(a) && r(f))) c.insertBefore(g, e),
                        h = !0;
                        h || c.appendChild(g)
                    }
                return h
    ...
    O.prototype["stroke-widthSetter"] = O.prototype.strokeSetter = function (a, b, c) {
            ...
            O.prototype.fillSetter.call(this, this.stroke, "stroke", c),
                            ...
                            if (e !== "" || g.length === 1) {
                                ...
                                if (e !== " ") {
                                        ...
                                        if (m) {
                                            ...
                                            (p || z) && (q.length || r.length);) a.rotation = 0,
                                            G = a.getBBox(!0),
                                            S = G.width,
                                            !fa && c.forExport && (S = c.measureSpanWidth(s.firstChild.data, a.styles)),
                                            G = S > m,
                                            k === void 0 && (k = G),
                                            z && k ? (x /= 2, y === "" || !G && x < 0.5 ? q = [] : (y = e.substring(0, y.length + (G ? -1 : 1) * ua(x)), q = [y + (m > 3 ? "\u2026" : "")], s.removeChild(s.firstChild))) : !G || q.length === 1 ? (q = r, r = [], q.length && (u++, s = A.createElementNS(Ha, "tspan"), P(s, {
                                                dy: t,
                                                x: j
                                            }), o && P(s, "style", o), b.appendChild(s)), S > m && (m = S)) : (s.removeChild(s.firstChild), r.unshift(q.pop())),
                                            q.length && s.appendChild(A.createTextNode(q.join(" ").replace(/- /g, "-")));
                                            a.rotation = B
                                        }
                                        n++
                                    }
            ...
            label: function (a, b, c, d, e, f, g, h, i) {
                ...
                Ab = function () {
                        ...
                        if (A) {
                            if (!m) a = t,
                            b = (h ? -x : 0) + t,
                            j.box = m = d ? k.symbol(d, a, b, j.width, j.height, $) : k.rect(a, b, j.width, j.height, 0, $["stroke-width"]),
                ...
                shadow: function (a, b, c) {
                    ...
                    if (a) {
                            ...
                            for (e = 1; e <= 3; e++) {
                                ...
                                if (c) h.cutOff = l + 1;
                                k = ['<stroke color="', a.color || "#fff", '" opacity="', q * e, '"/>'];
            ...
            var Bb = {
                ...
                color: function (a, b, c, d) {
                    ...
                    if (i) {
                            ...
                            n = m.x2 || m[2] || 0,
                            m = m.y2 || m[3] || 0,
                            w = 'angle="' + (90 - Y.atan((m - a) / (n - c)) * 180 / ra) + '"',
                            r();
                            else {
                                    var k = m.r,
                                        $ = k * 2,
                        ...
                        } else if (g.test(a) && b.tagName !== "IMG") f = ma(a),
    ...
    Va.prototype = {
            ...
            render: function (a, b, c) {
                ...
                h = this.getMarkPath($, r, m[0], m[1] * t, g, f),
                p ? p.animate({
                        d: h,
                        opacity: c
                ...
                if (i && J($)) i.xy = r = this.getLabelPosition($, r, i, g, j, S, a, w),
                this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? v = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(r),
                w && a % w && (v = !1),
                v && J(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999)
            },
            destroy: function () {
                Ra(this, this.axis)
            }
    ...
    x.PlotLineOrBand.prototype = {
            render: function () {
                ...
                if (g) {
                        ...
                        if (z) w.fill = z;
                        if (d.borderWidth) w.stroke = d.borderColor,
    ...
    ha.prototype = {
            ...
            defaultLabelFormatter: function () {
                ...
                else if (f && a >= 1E3) for (; f-- && g === y;) c = Math.pow(1E3, f + 1),
                a >= c && b * 10 % c === 0 && e[f] !== null && (g = x.numberFormat(b / c, -1) + e[f]);
            ...
            getSeriesExtremes: function () {
                ...
                p(a.series, function (c) {
                        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            a.isLog && e <= 0 && (e = null);
                            if (a.isXAxis) {
                                    if (d = c.xData, d.length) c = La(d),
                                    !J(c) && !(c instanceof la) && (d = Ba(d, function (a) {
                                        return J(a)
                                    }), c = La(d)),
                                    a.dataMin = F(o(a.dataMin, d[0]), c),
                                    a.dataMax = t(o(a.dataMax, d[0]), Ga(d))
                                } else {
                                    c.getExtremes();
                                    f = c.dataMax;
                                    c = c.dataMin;
                                    if (r(c) && r(f)) a.dataMin = F(o(a.dataMin, c), c),
                                    a.dataMax = t(o(a.dataMax, f), f);
            ...
            setTickInterval: function (a) {
                ...
                if (e)!a && F(b.min, o(b.dataMin, b.min)) <= 0 && aa(10, 1),
                b.min = ca(f(b.min), 15),
                b.max = ca(f(b.max), 15);
                if (b.range && r(b.max)) b.userMin = b.min = w = t(b.min, b.minFromRange()),
                b.userMax = v = b.max,
                b.range = null;
                I(b, "foundExtremes");
                b.beforePadding && b.beforePadding();
                b.adjustForMinRange();
                if (!n && !b.axisPointRange && !b.usePercentage && !i && r(b.min) && r(b.max) && (f = b.max - b.min))!r(w) && j && (b.min -= f * j),
                !r(v) && k && (b.max += f * k);
            ...
            unsquish: function () {
                ...
                b ? (j = !a.staggerLines && !a.step && (r(g) ? [g] : e < o(a.autoRotationLimit, 80) && a.autoRotation)) && p(j, function (a) {
                        var b;
                        if (a === g || a && a >= -90 && a <= 90) i = l(Q(h.h / da(ja * a))),
                        b = i + Q(a / 360),
                        b < k && (k = b, f = a, d = i)
                    }) : a.step || (d = l(h.h));
                this.autoRotation =
            ...
            getOffset: function () {
                ...
                if (k || a.isLinked) {
                        ...
                        a.labelOffset = s * (a.opposite ? -1 : 1)
            ...
            render: function () {
                ...
                if (a.hasData() || g) {
                        ...
                        if (h.length && (p(h, function (b, c) {
                            ...
                            o && k[b].isNew && k[b].render(c, !0, 0.1),
                            k[b].render(c)
                        }), q && (a.min === 0 || a.single))) k[-1] || (k[-1] = new Va(a, -1, null, !0)),
                        k[-1].render(-1);
                        n && p(h, function (c, d) {
                            t = h[d + 1] !== y ? h[d + 1] + q : a.max - q;
                            if (d % 2 === 0 && c < a.max && t <= a.max + (b.polar ? -q : q)) l[c] || (l[c] = new x.PlotLineOrBand(a)),
                            r = c + q,
                            l[c].options = {
                                from: e ? f(r) : r,
                                to: e ? f(t) : t,
    ...
    ha.prototype.getTimeTicks = function (a, b, c, d) {
            ...
            if (r(b)) {
                    ...
                    b = 1;
                    if (qb || Za) i = i.getTime(),
                    i = new la(i + Ya(i));
                    h = i[bb]();
                    for (var d = i.getTime(), l = i[ab](), m = i[Ua](), n = !g || !! Za, q = (H.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % H.day; d < c;) e.push(d),
                    k === H.year ? d = jb(h + b * j, 0) : k === H.month ? d = jb(h, l + b * j) : n && (k === H.day || k === H.week) ? d = jb(h, l, m + b * j * (k === H.day ? 1 : 7)) : d += k * j,
                    b++;
                    e.push(d);
                    p(Ba(e, function (a) {
    ...
    Xa.prototype = {
            init: function (a, b) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                if (x.Tooltip && b.tooltip.enabled) a.tooltip = new Ob(a, b.tooltip),
                this.followTouchMove = o(b.tooltip.followTouchMove, !0);
                this.setDOMEvents()
            },
            ...
            reset: function (a, b) {
                ...
                if (a) g && h && (g.refresh(h), e && (e.setState(e.state, !0), p(c.axes, function (a) {
                        ...
                        if (d) d.onMouseOut();
                        g && g.hide(b);
                        if (this._onDocumentMouseMove) X(A, "mousemove", this._onDocumentMouseMove),
    ...
    if (D.PointerEvent || D.MSPointerEvent) {
            var va = {},
                ...
                Db = function (a, b, c, d) {
                    if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && T[ia]) d(a),
                    d = T[ia].pointer,
                    d[b]({
                        type: c,
    ...
    ob.prototype = {
            init: function (a, b) {
                ...
                c.itemHiddenStyle = E(d, b.itemHiddenStyle),
                c.itemMarginTop = e,
                c.padding = d = o(b.padding, 8),
                c.initialItemX = d,
                c.initialItemY = d - 5,
                c.maxItemWidth = 0,
                c.chart = a,
            ...
            renderItem: function (a) {
                ...
                if (!s) {
                        ...
                        if (!this.baseline) this.fontMetrics = c.fontMetrics(h.fontSize, s),
                        this.baseline = this.fontMetrics.f + 3 + q,
                        s.attr("y", this.baseline);
                ...
                if (e && this.itemX - z + f > (m || b.chartWidth - 2 * k - z - d.x)) this.itemX = z,
                ...
                if (a > f && k.enabled !== !1) {
                        ...
                        p(s, function (a, b) {
                            var c = a._legendItemPos[1],
                                ...
                                e = n.length;
                            if (!e || c - n[e - 1] > h && (z || c) !== n[e - 1]) n.push(z || c),
                            e++;
    ...
    gb.prototype = {
            ...
            linkSeries: function () {
                ...
                p(b, function (b) {
                        ...
                        b.linkedParent = d,
                        b.visible = o(b.options.visible, d.options.visible, b.visible)
                    })
            },
    ...
    R.prototype = {
            ...
            bindAxes: function () {
                ...
                p(a.axisTypes || [], function (e) {
                        p(c[e], function (c) {
                            d = c.options;
                            if (b[e] === d.index || b[e] !== y && b[e] === d.id || b[e] === y && d.index === 0) c.series.push(a),
                            a[e] = c,
                            c.isDirty = !0
                        });
                ...
                if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) p(a, function (a, b) {
                        ...
                        if (n && h > n) {
                            ...
                            if (J(j)) {
                                ...
                                m += j;
                                e.xIncrement = m
                            } else if (Ea(j)) if (s) for (c = 0; c < h; c++) j = a[c],
                            q[c] = j[0],
                            z[c] = j.slice(1, s + 1);
            ...
            processData: function (a) {
                ...
                d > 0 && (g === y || d < g) ? g = d : d < 0 && this.requireSorting && aa(15);
                this.cropped = f;
                this.cropStart = e;
            ...
            generatePoints: function () {
                ...
                for (m = 0; m < g; m++) i =
                h + m,
                k ? (l[m] = (new f).init(this, [d[m]].concat(ta(e[m]))), l[m].dataGroup = this.groupMap[m]) : (b[i] ? j = b[i] : a[i] !== y && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j),
                l[m].index = i;
            ...
            translate: function () {
                ...
                for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !! this.modifyValue, i = a.pointPlacement, k = i === "between" || J(i), j = a.threshold, l = a.startFromThreshold ? j : 0, m, n, q, p, s = Number.MAX_VALUE, a = 0; a < g; a++) {
                    ...
                    if (e.isLog && v !== null && v <= 0) G.y = v = null,
                    aa(10);
                    G.plotX = m = ca(F(t(-1E5, c.translate(w, 0, 0, 0, 1, i, this.type === "flags")), 1E5));
                    if (b && this.visible && !G.isNull && u && u[w]) p = this.getStackIndicator(p, w, this.index),
                    u = u[w],
                    v = u.points[p.key],
                    n = v[0],
                    v = v[1],
                    ...
                    u.total,
                    G.percentage = u.total && G.y / u.total * 100,
                    G.stackY = v,
            ...
            applyZones: function () {
                var a = this,
                    ...
                    z = l.horiz,
                    s, r, w, v = !1;
                if (d.length && (i || k) && l.min !== y) i && i.hide(),
                k && k.hide(),
                m = l.getExtremes(),
                p(d, function (d, p) {
    ...
    R.prototype.setStackedPoints = function () {
            if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
                ...
                for (w = 0; w < d; w++) {
                        ...
                        s = m[s][v];
                        if (u !== null) s.points[r] = s.points[this.index] = [o(s.cum, g)],
                        s.touched = l.stacksTouched,
                        q.index > 0 && this.singleStacks === !1 && (s.points[r][0] = s.points[this.index + "," + v + ",0"][0]);
                        ...
                        s.cum = o(s.cum, g) + (u || 0);
                        if (u !== null) s.points[r].push(s.cum),
                        c[w] = s.cum
                    }
    ...
    R.prototype.setPercentStacks = function () {
            ...
            p([b, "-" + b], function (b) {
                    var f;
                    for (var g = d.length, h, i; g--;) if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0,
                    h[0] = ca(h[0] * i),
                    h[1] = ca(h[1] * i),
    ...
    u(gb.prototype, {
            ...
            showLoading: function (a) {
                ...
                b.loadingSpan = ba("span", null, e.labelStyle, d),
                N(b, "redraw", f);
                        ...
                        p(b, function (g, i) {
                            ...
                            p([-1, 1], function (a) {
                                    var c = a === 1 ? "rightNull" : "leftNull",
                                        d = 0,
                                        n = e[b[i + a]];
                                    if (n) for (m = h; m >= 0 && m < k;) o = n.points[m],
                                    o || (m === h ? f[g][c] = !0 : j[m] && (r = e[g].points[m]) && (d -= r[1] - r[0])),
                                    m += l;
    ...
    wa = qa(R, {
            ...
            getColumnMetrics: function () {
                ...
                b.grouping === !1 ? h = 1 : p(a.chart.series, function (b) {
                        var c = b.options,
                            e = b.yAxis,
                            i;
                        if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === y && (g[f] = h++), i = g[f]) : c.grouping !== !1 && (i = h++),
                        b.columnIndex = i
                    });
            ...
            drawPoints: function () {
                ...
                p(a.points, function (h) {
                        var i = h.graphic,
                            k;
                        if (J(h.plotY) && h.y !== null) f = h.shapeArgs,
                        k = r(a.borderWidth) ? {
                                "stroke-width": a.borderWidth
                            } : {},
                        g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""],
                        i ? (Oa(i), i.attr(k).attr(g)[b.pointCount < e ? "animate" : "attr"](E(f))) : h.graphic = d[h.shapeType](f).attr(k).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
    ...
    R.prototype.drawDataLabels = function () {
            ...
            p(e, function (e) {
                    ...
                    if (j && !h) e.dataLabel = j.destroy();
                            ...
                            v.color = o(d.color, v.color, a.color, "#fff");
                            if (j) if (r(i)) j.attr({
                                text: i
                            }),
                            w = !1;
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
            ...
            q ? this.justifyDataLabel(b, c, g, k, d, e) : o(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)),
            c.shape && !l && b.attr({
                    anchorX: a.plotX,
                    anchorY: a.plotY
                });
    ...
    if (L.pie) L.pie.prototype.drawDataLabels = function () {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    p(b, function (a) {
                        if (a.dataLabel && a.visible) x[a.half].push(a),
                    ...
                    for (E = 2; E--;) {
                        ...
                        if (L) {
                                ...
                                for (C = b = 0; !b && J[C];) b = J[C] && J[C].dataLabel && (J[C].dataLabel.getBBox().height || 21),
                                C++;
                                if (m > 0) {
                                ...
                                for (C = 0; C < L; C++) {
                                    ...
                                    u.connX = y;
                                    u.connY = A;
                                    if (this.options.size === null) w = u.width,
                                    y - w < f ? H[3] = t(B(w - y + f), H[3]) : y + w > h - f && (H[1] = t(B(y + w - h + f), H[1])),
                                    A - b / 2 < 0 ? H[0] = t(B(-A + b / 2), H[0]) : A + b / 2 > i && (H[2] = t(B(A + b / 2 - i), H[2]))
                                }
                            }
                    }
                    if (Ga(H) === 0 || this.verifyDataLabelOverflow(H)) this.placeDataLabels(),
                    s && g && p(this.points, function (b) {
                        k = b.connector;
                        v = b.labelPos;
                        if ((u = b.dataLabel) && u._pos && b.visible) D = u._attr.visibility,
                        y = u.connX,
                        A = u.connY,
                        j = l ? ["M", y + (v[6] === "left" ? 5 : -5), A, "C", y, A, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], "L", v[4], v[5]] : ["M", y + (v[6] === "left" ? 5 : -5), A, "L", v[2], v[3], "L", v[4], v[5]],
                        k ? (k.animate({
                            d: j
    ...
    u(Ja.prototype, {
            select: function (a, b) {
                ...
                c.firePointEvent(a ? "select" : "unselect", {
                        ...
                        b || p(e.getSelectedPoints(), function (a) {
                            ...
                            d.options.data[sa(a, d.data)] = a.options,
                            a.setState(""),
            ...
            onMouseOut: function () {
                ...
                if (!b || sa(this, b) === -1) this.setState(),
                a.hoverPoint = null
            },
